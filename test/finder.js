(function () {
	...
	function Test () {
		...
		this.body = function () {
			...
			driver.wait(function () { // click to "search" button until this is displayed
					return driver.findElement({ css: selector.gameFinder.gameFind }).click().then(dep.trueFn, dep.falseFn);
				}, 25000);

			driver.findElement({ css: selector.gameFinder.searchField }).sendKeys('a');
			...
			driver.findElement({ css: selector.gameFinder.clearSearch }).click();
